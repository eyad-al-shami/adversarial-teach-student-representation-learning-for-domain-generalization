...
_C.MODEL.TEACHER.UPDATE_SPECIFIC_LAYERS = True
_C.MODEL.TEACHER.UPDATE_SPECIFIC_LAYERS_NAMES = ['conv1', 'bn1', 'layer1']

_C.MODEL.AUGMENTER = CN()
_C.MODEL.AUGMENTER.LR = 0.0001
_C.MODEL.AUGMENTER.NORM_LAYER = "BN" # BN or IN
