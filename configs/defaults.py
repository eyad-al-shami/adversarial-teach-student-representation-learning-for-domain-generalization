...
_C.MODEL.TEACHER.TAU = 0.999
_C.MODEL.TEACHER.WARMUP_EPOCHS = 10
_C.MODEL.TEACHER.PRETRAINED = True
_C.MODEL.TEACHER.WARMUP_LR = 0.001

_C.MODEL.AUGMENTER = CN()
_C.MODEL.AUGMENTER.LR = 0.005
_C.MODEL.AUGMENTER.NORM_LAYER = "BN"
_C.MODEL.AUGMENTER.DISCREPANCY_LOSS_WEIGHT = 0.3
